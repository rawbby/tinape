foreach (TARGET_DIR ${HEADER_DIRS})
    ...
    target_sources(${TARGET_NAME} INTERFACE FILE_SET target_include TYPE HEADERS FILES ${TARGET_INCLUDE})
    ...
    if (${TARGET_CLANG_TIDY_AUTO_SOURCE})
        clang_tidy_sources(${TARGET_INCLUDE})
    endif ()
    if (${TARGET_CLANG_FORMAT_AUTO_SOURCE})
        clang_format_sources(${TARGET_INCLUDE})
    endif ()
